...
const config: Config = {
  ...
  url: 'https://nucleardocs.netlify.app',
  ...
  organizationName: 'nuclearapp', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Nuclear, Inc. Built by Docusaurus.`,
    },
    prism: {
